...
const (
	...
	defaultRPCPort            = 11007
	defaultRESTPort           = 8080
	defaultPeerPort           = 9122
...
type Config struct {
	...
	RawExternalIPs   []string `long:"externalip" description:"Add an ip:port to the list of local addresses we claim to listen on to peers. If a port is not specified, the default (9122) will be used regardless of other parameters"`
