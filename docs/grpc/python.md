...
channel = grpc.secure_channel('localhost:11007', creds)
...
is at the default `localhost:11007`, with an open channel between the two nodes.
...
channel = grpc.secure_channel('localhost:11007', combined_creds)
stub = lnrpc.LightningStub(channel)
